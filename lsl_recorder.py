...
parser.add_option("-d", "--duration",
                  ...
                  help="duration of the recording in seconds.") # 命令行参数 duration 持续时间
parser.add_option("-f", "--filename",
                  dest="filename", type='str', default=default_fname, # 命令行参数 文件名称
...
eeg_time_correction = inlet.time_correction() # Retrieve an estimated time correction offset for the given stream
